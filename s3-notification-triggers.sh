...
bucket_name="skr-s3-bucket"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns"
email_address="saikishorereddy789@gmail.com"
...
topic_arn=$(aws sns create-topic --name s3-lambda-sns | grep s3-lambda-sns | awk -F " " '{print $2}' | tr -d '"')
...
aws sns publish \
  ...
  --message "Hello from sai kishore"
